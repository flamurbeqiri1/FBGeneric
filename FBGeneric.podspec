#
#  Be sure to run `pod spec lint FBGeneric.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "Flamur Beqiri"
  # spec.authors            = { "Flamur Beqiri" => "flamurbeqiri1@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Flamur Beqiri"
